...
TauCand::TauCand(const TauWP& wp, const Tau& tau, double sf):
	...
	decayModeFindingOldDMs(tau.TauDiscriminator("decayModeFindingOldDMs") > 0.5),
	...
	byTightIsolationMVA3oldDMwLT(tau.TauDiscriminator("byTightIsolationMVA3oldDMwLT") > 0.5),
