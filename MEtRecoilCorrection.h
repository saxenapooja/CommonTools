...
class MEtRecoilCorrection
{
 public:
  ...
  TLorentzVector RecoilCorrectedMET(TLorentzVector pfMet_, LorentzVector lepLeg1_, LorentzVector lepLeg2_,  GenParticle genParticles, int nGenParticle_, int nJets_, std::string sampleName_);
...
TLorentzVector MEtRecoilCorrection::RecoilCorrectedMET(TLorentzVector pfMet_, LorentzVector lepLeg1_, LorentzVector lepLeg2_,  GenParticle genParticles, int nGenParticle_, int nJets_, std::string sampleName_)
{
  ...
  corrector_->CorrectType1(newPfMetPt_,newPfMetPhi_,genVP4_.Pt() ,genVP4_.Phi(), 
			   diLepton_.Pt(),diLepton_.Phi(), u1, u2 , 0 , 0, TMath::Min(nJets_,2) );
...
#endif // _WHANALYSIS_ELECTRONID_H_
